 ...
 * @author o_0fe
 */
public class Port_Entrada extends javax.swing.JFrame {

    /**
     * Creates new form Port_Entrada
     */
    public Port_Entrada() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Hora da Entrada:");

        jLabel6.setText("Hora da Saida:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Port_Entrada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Port_Entrada().setVisible(true);
            }
        });
    }
